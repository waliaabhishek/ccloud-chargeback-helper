...
class MetricsAPITopicDataColumnNames:
    timestamp = "Interval"
...
METRICS_API_COLUMNS = MetricsAPITopicDataColumnNames()
        ...
        temp_data = [
            {
                ...
                METRICS_API_COLUMNS.topic: item["metric"]["topic"],
